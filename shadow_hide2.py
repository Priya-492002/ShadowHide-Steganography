...
class ShadowHideApp(ctk.CTk):
    ...
    def open_encode_view(self):
        ...
        # IMPORTANT: Force .png extension here
    ...
    def open_decode_view(self):
        ...
        # Added wraplength to handle longer messages in the UI
        label = ctk.CTkLabel(result_window, text=f"The secret is:\n\n{secret_msg}", font=("Roboto", 14), wraplength=350)
        label.pack(pady=30)
    ...
    def hide_message(self, image_path, message, output_path):
        ...
        # Add the delimiter so the decoder knows where to stop
        message += "#####" 
            ...
            for x in range(width):
                ...
                for n in range(3): # Red, Green, Blue channels
                    if data_index < len(binary_msg):
                        # This logic is correct: it flips the last bit to match our binary_msg
                ...
                if data_index >= len(binary_msg):
                    # Force save as PNG to prevent compression loss
            ...
            for x in range(img.width):
                ...
                for n in range(3):
                    ...
                    if len(binary_data) == 8:
                        ...
                        decoded_msg += char
                        binary_data = "" # Reset for the next character
